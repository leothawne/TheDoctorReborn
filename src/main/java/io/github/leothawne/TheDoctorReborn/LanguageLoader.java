...
public class LanguageLoader {
	public static final void check(TheDoctorReborn plugin, ConsoleLoader myLogger, FileConfiguration configuration) {
	...
	public static final FileConfiguration load(TheDoctorReborn plugin, ConsoleLoader myLogger, FileConfiguration configuration) {
